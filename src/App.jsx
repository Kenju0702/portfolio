              ...
              <div className="md:w-1/2 mx-auto text-center ">
                <div id="About">
                  <ContentSection
                    title={"About"}
                    content={
                      "Currently, I am a final-year Information Technology student at Saigon University (SGU) and living in Cu Chi, Ho Chi Minh City. Throughout my studies, I have built a solid foundation in programming, particularly with languages such as JavaScript, along with proficiency in using tools like Git and Postman."
                    }
                  />
                  <AboutDetail />
                </div>
